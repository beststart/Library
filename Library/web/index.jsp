    ...
    <div id="body">
        ...
        <div class="row">
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="static/imgs/logoko.png" alt="...">
                    <div class="caption">
                        <h3>射雕英雄传</h3>
                        <p>作者：金庸</p>
                        <p class="intro" title="adsasdasd">射雕英雄传射雕英雄传射雕英雄传射雕英雄传射雕英雄传射雕英雄传射雕英雄传射雕英雄传...</p>
                        <p>
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        <h3>射雕英雄传</h3>
                        <p>作者：金庸</p>
                        <p class="intro">射雕英雄传射雕英雄传射雕英雄传射雕英雄传射雕英雄传射雕英雄传射雕英雄传射雕英雄传射雕英雄传</p>
                        <p>
                            <a href="#" class="btn btn-default" role="button">详情</a>
                            <a href="#" class="btn btn-default" role="button">借阅</a>
                        </p>
