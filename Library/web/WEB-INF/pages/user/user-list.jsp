...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        ...
        <div class="panel-body">
            <form id="formSearch" class="form-inline">
                <div class="form-group">
                    <label class="control-label" for="srname">真实姓名</label>
                    <input type="text" class="form-control" id="srname">
                </div>
                <div class="form-group">
                    <label class="control-label" for="sphone">联系电话</label>
                    <input type="text" class="form-control" id="sphone">
                </div>
                <div class="form-group">
                    <label class="control-label" for="spower">权限</label>
                    <select id="spower" class="form-control">
    ...
    <div class="table-responsive">
        <div id="toolbar" class="btn-group">
            <a href="user?type=toEdit" data-toggle="modal" data-target="#modal" class="btn btn-default">
...
<script>
    $(function () {
        ...
        $('#btn_query').click(function () {
            var realname=$('#srname').val();
            var phone=$('#sphone').val();
            var powerid=$('#spower').val();
