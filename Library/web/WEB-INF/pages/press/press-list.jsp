...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    ...
    <div class="table-responsive">
        <div id="toolbar" class="btn-group">
            <a href="press?type=toEdit" data-toggle="modal" data-target="#modal" class="btn btn-default">
...
<script>
    ...
    function optFun(value, row) {
        return '<a class="btn btn-primary" href="press?type=toEdit&id=' + row.id + '" data-toggle="modal" data-target="#modal">修改</a> <a class="btn btn-primary" onclick="delInfo(' + row.id + ');" type="button" >删除</a>';
    }
